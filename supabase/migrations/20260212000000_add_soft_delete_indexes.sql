...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deals_owner_active 
ON public.deals (owner_id) 
WHERE deleted_at IS NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deals_stage_active 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_contacts_owner_active 
ON public.contacts (owner_id) 
WHERE deleted_at IS NULL;

-- 3. Activities
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_active 
ON public.activities (id) 
WHERE deleted_at IS NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_activities_deal_active 
