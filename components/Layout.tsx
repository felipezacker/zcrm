    ...
    <div className="flex h-screen overflow-hidden bg-surface-bg bg-dots">
      ...
      <div className="flex-1 w-full flex min-w-0 overflow-hidden relative">
        ...
        <div className="flex-1 w-full flex flex-col min-w-0 overflow-hidden relative">
          ...
          {/* Header */}
          <header className="h-16 glass border-b border-border-subtle flex items-center justify-end px-6 z-40 shrink-0" role="banner">
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="p-2 text-text-muted hover:text-primary hover:bg-muted rounded-full transition-all active:scale-95 focus-visible-ring"
              >
        ...
        <aside
          ...
          className={`border-l border-border bg-surface transition-all duration-300 ease-in-out overflow-hidden flex flex-col ${isGlobalAIOpen ? 'w-96 opacity-100' : 'w-0 opacity-0'}`}
        >
