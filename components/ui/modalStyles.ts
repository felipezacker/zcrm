...
export const MODAL_OVERLAY_CLASS =
  ...
  'fixed inset-0 lg:left-[var(--app-sidebar-width,0px)] z-[9999] flex items-stretch sm:items-center justify-center bg-[rgba(15,23,42,0.6)] backdrop-blur-sm p-2 xs:p-3 sm:p-4';
...
export const MODAL_HEADER_CLASS =
  'p-3 xs:p-3.5 sm:p-4 border-b border-[var(--color-border)] flex items-center justify-between shrink-0 gap-2';
...
export const MODAL_BODY_CLASS = 'p-3 xs:p-4 sm:p-5 text-[var(--color-foreground)] text-sm xs:text-base overflow-y-auto';

export const MODAL_FOOTER_CLASS =
  'p-3 xs:p-4 sm:p-5 border-t border-[var(--color-border)] bg-[var(--color-background-secondary)] shrink-0 flex gap-2 xs:gap-3 sm:gap-4';
